...
// Используем скомпилированный JavaScript из dist директории
import { submitUserInfoToGoogleSheets, submitDetailedResultsToGoogleSheets } from './dist/assets/index-D_0w1fS2.js';
